...
if __name__ == "__main__":
    if resume_epoch != nEpochs:
        ...
        trainloader = DataLoader(coco_train, batch_size=p['trainBatch'], shuffle=True, num_workers=0)
        testloader = DataLoader(coco_val, batch_size=testBatch, shuffle=False, num_workers=0)
        ...
        for epoch in range(resume_epoch, nEpochs):
            ...
            net.train()
            for x in enumerate(trainloader):
                try:
                    ii, sample_batched = x
